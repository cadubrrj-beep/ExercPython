'''
Read three values (variables A, B and C), which are the three students grades.
...
Output
Print the message "MEDIA"(average in Portuguese) and the
students average according to the following example, with a blank space before and
